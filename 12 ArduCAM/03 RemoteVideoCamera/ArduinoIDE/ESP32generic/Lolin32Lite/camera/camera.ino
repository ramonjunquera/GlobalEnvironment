/*
  ...
  Material adicional: placa WeMos Lolin32 Lite, ArduCAM-Mini-2MP
*/
...
//Definimos pin CS de la cámara
const byte pinCS=17;
//En WeMos Lolin32 Lite no tenemos los pines estandar de I2C
//Tenemos que definir pines específicos
const byte pinSDA=4;
const byte pinSCL=13;
//En placas genéricas no está definido el pin del led integrado
//Para WeMos Lolin32 Lite es el pin 2
...
RoJoArduCAM camera;
//Creamos el sprite que utilizaremos para guardar la imagen
RoJoSprite16 sprite;
...
void setup()
{
  ...
  byte errorCode = camera.begin(pinCS,pinSDA,pinSCL);
