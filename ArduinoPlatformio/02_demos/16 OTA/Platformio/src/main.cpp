/*
  ...
  Sólo para controladores con posibilidad WiFi: la familia ESP
  ...
  - Si obtenemos errores al transferir por OTA debido a problemas con mDNS es posible que el fallo
    se encuentre en el PC y no es el dispositivo/programa. Reinicia.
*/
