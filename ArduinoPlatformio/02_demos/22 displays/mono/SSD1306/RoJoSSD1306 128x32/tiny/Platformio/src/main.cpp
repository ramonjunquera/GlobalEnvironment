/*
  ...
  Fecha: 20220503
  Tema: Librería para display OLED I2C 0.91" 128x32 SSD1306
  ...
  de vídeo de 0.5Kb, pero ATtiny85 sólo tiene 0.5Kb para variables.
...
void setup() {
  ...
  if(!display.begin(true)) { //Si no se puede inicializar...
