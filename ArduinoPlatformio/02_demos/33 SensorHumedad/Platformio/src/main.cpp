/*
  ...
  Aparte de los pines de alimentación, sólo tiene un pin de datos analógico.
  Su rango de voltaje de entrada es de 3.3 a 5.5V.
  ...
  - Es importante que la marca de límite quede por encima de la tierra. No hace falta apurar.
    Si lo hacemos, tendremos que todos los valores obtenidos rondan el 100%.  
