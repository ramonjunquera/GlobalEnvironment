/*
  ...
  Protocolo:
  - Una imágen consta de 8 filas, 8 columnas y 3 canales de color por pixel.
  ...
  - El Listener de clicks del objeto View8 es llamado con cada evento... Un cambio de posición de
            ...
            while(true) { //bucle infinito
                ...
                if(changeRequest.compareTo(lastChangeRequest)>0) {
                    ...
                    if(ui.switchConectar.isChecked) { //Si tenemos conexión...
                        ...
                        pack[0]=(changeRequest.col*8+changeRequest.row).toByte() //Coordenadas ..xxxyyy
