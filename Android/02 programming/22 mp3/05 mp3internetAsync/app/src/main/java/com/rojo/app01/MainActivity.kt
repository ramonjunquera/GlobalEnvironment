/*
  ...
  - La novedad de este ejemplo es que la descarga del archivo desde Internet se realiza de manera
    ...
    liberado y no se bloquea el interface de usuario.
  ...
  - Desde el ejemplo anterior, cambiamos la variable playing:Boolean a playStatus:Int, puesto que
    ahora tenemos 3 estados y no dos: 0=Parado, 1=Descargando, 2=Reproduciendo
  - Si se detecta una pulsación del botón mientras está descargando, no haremos nada (porque no podemos).
