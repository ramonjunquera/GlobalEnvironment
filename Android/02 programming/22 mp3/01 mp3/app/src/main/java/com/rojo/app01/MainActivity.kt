/*
  ...
  Estructura:
  - Dentro de la carpeta app/src/main/res/raw se guardan los archivos mp3. Esta carpeta se puede ver
    en Android Studio en el path app/res/raw.
  ...
  - Si cuando se pulsa un botón, simplemente instanciamos un objeto MediaPlayer y comenzamos su
    ...
    llamado al finalizar la reproducción del audio y que se encargue de borrar el objeto de memoria
