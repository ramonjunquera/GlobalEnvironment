/*
  Nombre de la librería: RoJoTimerAVR1.h
  Versión: 20191006
  Autor: Ramón Junquera
  Tema: Gestión de interrupciones para placas Arduino. Timer 1
...
#ifndef RoJoTimerAVR1_h
#define RoJoTimerAVR1_h
...
RoJoTimerAVR1 timerAVR1; //Creamos el objeto del timer con nombre fijo
...
ISR(TIMER1_COMPA_vect) {
  timerAVR1._update(); //Actualizamos el estado de la interrupción
}
