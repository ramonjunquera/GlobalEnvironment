/*
  Nombre de la librería: RoJoTimerAVR2.h
  Versión: 20191006
  Autor: Ramón Junquera
  Tema: Gestión de interrupciones para placas Arduino. Timer 2
...
#ifndef RoJoTimerAVR2_h
#define RoJoTimerAVR2_h
...
RoJoTimerAVR2 timerAVR2; //Creamos el objeto del timer con nombre fijo
...
ISR(TIMER2_COMPA_vect) {
  timerAVR2._update(); //Actualizamos el estado de la interrupción
}
