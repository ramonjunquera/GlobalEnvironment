/*
  Nombre de la librería: RoJoTimerAVR3.h
  Versión: 20191006
  Autor: Ramón Junquera
  Tema: Gestión de interrupciones para placas Arduino. Timer 3. Sólo MEGA
...
#ifndef RoJoTimerAVR3_h
#define RoJoTimerAVR3_h
...
RoJoTimerAVR3 timerAVR3; //Creamos el objeto del timer con nombre fijo
...
ISR(TIMER3_COMPA_vect) {
  timerAVR3._update(); //Actualizamos el estado de la interrupción
}

#endif //ARDUINO_AVR_MEGA2560

#endif //RoJoTimerAVR3_h
