/*
  Nombre de la librería: RoJoTimerAVR5.h
  Versión: 20191006
  Autor: Ramón Junquera
  Tema: Gestión de interrupciones para placas Arduino. Timer 5. Sólo MEGA
...
#ifndef RoJoTimerAVR5_h
#define RoJoTimerAVR5_h
...
RoJoTimerAVR5 timerAVR5; //Creamos el objeto del timer con nombre fijo
...
ISR(TIMER5_COMPA_vect) {
  timerAVR5._update(); //Actualizamos el estado de la interrupción
}

#endif //ARDUINO_AVR_MEGA2560

#endif //RoJoTimerAVR5_h
