...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(172, 199);
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        dial_1 = new QDial(centralWidget);
        dial_1->setObjectName(QStringLiteral("dial_1"));
        dial_1->setGeometry(QRect(10, 10, 50, 64));
        dial_2 = new QDial(centralWidget);
        dial_2->setObjectName(QStringLiteral("dial_2"));
        dial_2->setGeometry(QRect(10, 80, 50, 64));
        lcdNumber = new QLCDNumber(centralWidget);
        lcdNumber->setObjectName(QStringLiteral("lcdNumber"));
        lcdNumber->setGeometry(QRect(90, 90, 64, 41));
        lcdNumber->setSegmentStyle(QLCDNumber::Flat);
        lineEdit = new QLineEdit(centralWidget);
        lineEdit->setObjectName(QStringLiteral("lineEdit"));
        lineEdit->setGeometry(QRect(90, 20, 61, 41));
        QFont font;
