/*
  ...
  Este ejemplo es incompatible con Arduino Mega debido al gran tamaño de los sprites
  utilizados. Mega no es tiene memoria suficiente.
...
void Test12()
{
  ...
  RoJoSprite16 imageSprite(pinCS_SD);
