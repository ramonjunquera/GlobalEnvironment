/*
  ...
  Material: breadboard, cables, placa ESP32, display OLED SSD1331
  ...
  El plugin del IDE para la subida del contenido de la carpeta data sólo es compatible
  con ESP8266, no con ESP32 (a fecha actual).
  Para gestionar los archivos se utiliza una versión modificada del servidor de FTP.
...
void Test13()
{
  ...
  font.print(F("20171028"),&textSprite,color);
  //Lo mostramos
...
void Test16()
{
  ...
  font.print("20171028",&textSprite,color);
