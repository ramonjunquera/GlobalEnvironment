/*
  ...
  Material: breadboard, cables, placa Arduino Mega, display LCD5110, lector SD
  Descripción:
...
void setup()
{
  ...
  //En placas Arduino no se puede desactivar el pin CS, así que si utilizamos 
  //más de un dispositivo SPI, tendremos que utilizar distintos pines para CS
  //y nunca el pin CS por defecto
