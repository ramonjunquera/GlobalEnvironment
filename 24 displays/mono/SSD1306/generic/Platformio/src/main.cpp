...
void test8() {
  ...
  RoJoSprite2 mySprite(0); //Creamos el sprite monocromo
...
void test12() {
  ...
  RoJoSprite2 backSprite(0); //Creamos un nuevo sprite monocromo para la imagen fija
  ...
  RoJoSprite2 ball(0); //Creamos un nuevo sprite monocromo para la imagen en movimiento
  //Leemos su contenido desde un archivo
  ball.loadSprite("/ball.spr"); //Su tamaño es x=30,y=30,pages=4
  
  RoJoSprite2 ballMask(0); //Creamos un nuevo sprite monocromo para la máscara de la imagen en movimiento
  //Leemos su contenido desde un archivo
...
void test13() {
  ...
  RoJoSprite2 mySprite(0); //Creamos un nuevo sprite monocromo
...
void test14() {
  ...
  RoJoSprite2 mySprite2(0);   //Creamos un nuevo sprite monocromo
...
void test15() {
  ...
  RoJoSprite2 resizeSprite(0); //Creamos el sprite monocromo utilizado para el redimensionado
...
void test16() {
  ...
  RoJoSprite2 textSprite(0); //Creamos el sprite monocromo que contendrá el texto
...
void test17() {
  ...
  RoJoSprite2 textSpriteRotate(0); //Creamos el sprite monocromo que contendrá el texto rotado
...
void test18() {
  ...
  RoJoSprite2 textSpriteFlip(0); //Creamos el sprite monocromo que contendrá el texto volteado
...
void test19() {
  ...
  RoJoSprite2 textSprite(0); //Creamos el sprite monocromo para el texto
...
void test20() {
  ...
  RoJoSprite2 textSprite(0); //Para escribir con borde necesitamos crear un sprite
