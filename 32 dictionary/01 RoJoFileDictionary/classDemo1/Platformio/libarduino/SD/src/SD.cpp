...
boolean SDClass::begin(uint8_t csPin) {
  ...
  //Serial.println("card.init="+String(card.init(SPI_HALF_SPEED, csPin))); //DEBUG
  //Serial.println("volume.init="+String(volume.init(card))); //DEBUG
  //Serial.println("root.openRoot="+String(root.openRoot(volume))); //DEBUG
