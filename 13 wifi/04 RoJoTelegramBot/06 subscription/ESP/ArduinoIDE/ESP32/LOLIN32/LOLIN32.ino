/*
  ...
  Descripción:
    ...
    número de suscriptores, excepto por la capacidad de SPIFFS y nuestra paciencia.
    ...
    Teniendo en cuenta las especificaciones del ESP32, jamás alcanzamos esta cifra. Por lo tanto, no nos preocuparemos
