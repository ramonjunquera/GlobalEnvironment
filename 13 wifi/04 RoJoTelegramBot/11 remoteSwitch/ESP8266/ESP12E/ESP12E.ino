/*
  ...
  Material: placa ESP-12E (simulación de Sonoff S20)
  Descripción:
...
const byte pinLed=LED_BUILTIN; //Pin del led
const byte pinRelay=D4; //Pin relay
const byte pinSwitch=D3; //Pin interruptor
