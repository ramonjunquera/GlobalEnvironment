  ...
  public partial class MainWindow : Window {
    ...
    protected void MyWorkerMain(object sender, DoWorkEventArgs e) {
      ...
      for (int sec = 1; sec <= secMax; sec++) {
        ...
        //En esta ocasión no sólo informaremos del porcentaje, sino que aprovecharemos el
        //parámetro userState para enviar un String personalizado.
        currentWorker.ReportProgress(sec, "Procesando " + sec.ToString() + "\n");
      }
      //Hemos terminado
    ...
    protected void MyWorkerCompleted(object sender, RunWorkerCompletedEventArgs e) {
      ...
      //Añadiremos un mensaje final a labelInfo. El de cancelación o el del resultado final.
    ...
    protected void MyWorkerProgress(object sender, ProgressChangedEventArgs e) {
      //Aprovechamos el valor del porcentaje de progreso para mostrarlo en la barra
      progressBar.Value = e.ProgressPercentage;
      //Añadimos un mensaje a labelInfo con el objeto userState, que sabemos que se trata de 
      //un String
      labelInfo.Content += e.UserState.ToString();
    }
    ...
    private void ButtonStart_Click(object sender, RoutedEventArgs e) {
      ...
      labelInfo.Content = "Thread lanzado\n"; //Informamos
