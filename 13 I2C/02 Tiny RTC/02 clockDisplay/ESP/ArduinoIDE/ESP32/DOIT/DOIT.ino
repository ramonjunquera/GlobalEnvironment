/*
  ...
  Material adicional: breadboard, placa DOIT ESP32 DevKit V1, cables, módulo "Tiny RTC I2C",
  ...
  Para cambiar de modo utilizaremos el interruptor integrado en placa (BOOT).
