/*
  ...
  Fecha: 20181102
  Material: breadboard, cables, placa ESP-01

  Descripción:
  Utilizaremos los dos únicos pines libres de esta placa (sin contar con los del puerto serie),
  para la conexión I2C: SCL=0, SDA=2.
  ...
  Las placas ESP-01 tienen una importante limitación de memoria. Aun así hay que recordar que debemos transferir
  los archivos de la carpeta data a la memoria SPIFFS.
  En este caso podemos comprobar que tenemos 4.2Kb de datos.
  Por lo tanto, crearemos una partición SPIFFS de al menos 32K.
...
void setup()
{
  ...
  //Tampoco utilizaremos el pin de reset, por lo tanto no lo informaremos.
  display.begin(SS,2,0);
}
