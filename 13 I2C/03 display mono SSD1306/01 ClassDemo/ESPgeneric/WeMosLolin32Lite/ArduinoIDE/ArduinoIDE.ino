/*
  ...
  Fecha: 20180524
  Material: breadboard, cables, placa WeMos Lolin32 Lite

  Descripción:
  Las placas no estandar, aquellas que deben ser programadas bajo el
  perfil de "ESP32 Dev Module", no implementan el protocolo I2C por
  hardware. Por ello se debe definir siempre los pines a utilizar.
  Tanto si el display está integrado como si es externo, intentaremos
  utilizar siempre los mismos pines, por coherencia.
  Estos son: SCL=15 y SDA=4.
...
void setup()
{
  //Inicializamos el display con la configuración seleccionada
