/*
  ...
  Material: breadboard, led, resistencia de 220 ohmios, potenciómetro de 10 Kohmios, cables, placa Arduino
  Descripción:
  ...
  Sólo como muestra usaremos la función map, que calcula con una regla de 3 el valor de salida.
