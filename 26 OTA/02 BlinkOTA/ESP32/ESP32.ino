...
#include <WiFi.h> //Para gestión de wifi
#include <ArduinoOTA.h> //Para gestión de OTA
//#include <SPIFFS.h> //Gestión de partición para archivos
...
void setup()
{
  ...
  ArduinoOTA.onStart([]()
  {
    ...
    //Si fuese el caso tendríamos el #include <SPIFFS.h> y deberíamos ejecutar:
