      ...
      if(_charInFont(text[i]))
      {
        ...
        for(byte p=0;p<_pages;p++)
        {
          ...
          for(byte c=0;c<chWidth;c++)
          {
            ...
            (*sprite).drawPage(x+c,p,pageByte,4);
          }
        }
