/*
  ...
  Material: breadboard, cables, placa ESP/Arduino Mega, display LCD5110, lector SD
  Descripción:
...
void Test13()
{
  ...
  RoJoSprite backSprite(pinCS_SD);
  //Leemos su contenido desde un archivo
...
void Test17()
{
  ...
  RoJoSprite resizeSprite(pinCS_SD);
  //Limpiamos pantalla
  display.videoMem->clear();
...
void Test18()
{
  ...
  RoJoSprite textSprite(pinCS_SD);
...
void Test19()
{
  ...
  RoJoSprite normalSprite(pinCS_SD);
  //Creamos objeto de gestión de fuentes
  RoJoABC font;
...
void setup()
{
  ...
  display.begin(pinRST_display,pinDC_display,pinCS_display,pinCS_SD);
}
