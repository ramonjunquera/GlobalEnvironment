/*
  ...
  Material: breadboard, Arduino board, 2x rotary encoder Keyes KY-040
  Description:
...
const byte encoder1PinSwitch = 4;
const byte encoder2PinA = 5;
const byte encoder2PinB = 6;
const byte encoder2PinSwitch = 7;
