/*
  ...
  Material: breadboard, ESP32 board, rotary encoder Keyes KY-040
  Description:
    ...
    ESP32 family can set interruptions on any pin, so we'll manage button with interruptions also.
