/*
  ...
  Material adicional: placa ESP8266, ArduCAM-Mini-2MP, display SSD1331
  Descripción:
...
void setup()
{
  ...
  byte errorCode = camera.begin(pinCScamera);
  ...
  display.begin(pinDC,pinRES,pinCSdisplay,8000000);
