/*
  ...
  Nota:
  Si utilizamos una placa MakerUNO no necesitaremos un interruptor externo. Ya se incluye uno integrado
  asociado al pin 2.
...
#if defined(ARDUINO_AVR_ATTINYX5) || defined(ARDUINO_AVR_DIGISPARK) //Si es una ATtiny85
  const byte pinLed = 1; //Pin del led integrado
