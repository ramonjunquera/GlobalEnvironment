...
RoJoSwitch button1(37); //Primer botón (M5)
...
void setup() {
  ...
  //Inicialización de display para M5Stick-C
  display.begin();
  //Rotamos el display. El botón M5 queda a la derecha
  display.rotation(1);
  //Inicialización de sensores
  GAM.begin(21,22); //En M5Stick-C es necesario indicar los pines
...
void loop() {
  ...
  //Teniendo en cuenta la rotación de pantalla, los ejes están intercambiados
  //y sus valores deben cambiar de signo
  accelX=dataA[1]-refXY[0];
  accelY=dataA[0]-refXY[1];
