/*
  ...
  Fecha: 20180621
  Objetivo: Demostración de clase de gestión del timer 4
  ...
  Nota:
  La librería RoJoTimer4 sólo es compatible con Arduino Mega, puesto que tiene 5 timers disponibles.
...
#include <Arduino.h>
#include "RoJoTimer4.h" //Gestión de timer 4. Se crea objeto timer4
...
void setup()
{
  ...
  timer4.begin(IntFunc,500000);
  //Esperamos 5 segundos
  delay(5000);
  //Parpadea cada décima de segundo
  timer4.begin(IntFunc,100000);
}
