/*
  ...
  Objetivo: Demostración de clase de gestión del timer 2
...
#include <Arduino.h>
#include "RoJoTimer2.h" //Gestión de timer 2. Se crea objeto timer2
...
void setup()
{
  ...
  timer2.begin(IntFunc,500000);
  //Esperamos 5 segundos
  delay(5000);
  //Parpadea cada décima de segundo
  timer2.begin(IntFunc,100000);
}
